    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='instajobs.Category', verbose_name='Category')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='instajobs.City', verbose_name='City')),
            ],
            options={
                'verbose_name': 'Job',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='instajobs.Job')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='job',
            name='jobtype',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='instajobs.Type', verbose_name='Job Type'),
        ),
    ]
